...
#include "../PultGlobalDefinitions.h"
    ...
    const EepromDefault internalRNDShakerPanHPF     =  {      0,            0x41F00000,         0x42700000};     //107
    const EepromDefault internalRNDShakerTiltHPF    =  {      0,            0x41F00000,         0x42700000};     //108
    const EepromDefault internalRNDShakerRollHPF    =  {      0,            0x41F00000,         0x42700000};     //109
    const EepromDefault internalRNDShakerZoomHPF    =  {      0,            0x41F00000,         0x42700000};     //110
    const EepromDefault internalRNDShakerPanLPF    =  {       0,             0x41200000,         0x42200000};     //111
    const EepromDefault internalRNDShakerTiltLPF    =  {      0,             0x41200000,         0x42200000};     //112
    const EepromDefault internalRNDShakerRollLPF    =  {      0,             0x41200000,         0x42200000};     //113
    const EepromDefault internalRNDShakerZoomLPF    =  {      0,             0x41200000,         0x42200000};     //114
