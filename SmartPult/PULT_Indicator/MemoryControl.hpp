...
enum EEPROM_Filds
{
    ...
    EE_LC_SHAKER_BLOCKING,
        ...
        EE_LC_INTERNAL_SHAKER_PAN_LPF,
        EE_LC_INTERNAL_SHAKER_TILT_LPF,
        EE_LC_INTERNAL_SHAKER_ROLL_LPF,
        EE_LC_INTERNAL_SHAKER_ZOOM_LPF,
        EE_LC_INTERNAL_SHAKER_PAN_HPF,
        EE_LC_INTERNAL_SHAKER_TILT_HPF,
        EE_LC_INTERNAL_SHAKER_ROLL_HPF,
        EE_LC_INTERNAL_SHAKER_ZOOM_HPF,
        EE_LC_INTERNAL_SIN_SHAKER_PAN_GAIN,
        EE_LC_INTERNAL_SIN_SHAKER_TILT_GAIN,
        EE_LC_INTERNAL_SIN_SHAKER_ROLL_GAIN,
        EE_LC_INTERNAL_SIN_SHAKER_ZOOM_GAIN,
        EE_LC_INTERNAL_SIN_SHAKER_PAN_FRIQ,
        EE_LC_INTERNAL_SIN_SHAKER_TILT_FRIQ,
        EE_LC_INTERNAL_SIN_SHAKER_ROLL_FRIQ,
        EE_LC_INTERNAL_SIN_SHAKER_ZOOM_FRIQ,
        EE_LC_INTERNAL_SIN_SHAKER_PAN_PHASE,
        EE_LC_INTERNAL_SIN_SHAKER_TILT_PHASE,
        EE_LC_INTERNAL_SIN_SHAKER_ROLL_PHASE,
        EE_LC_INTERNAL_SIN_SHAKER_ZOOM_PHASE,
        EE_LC_EXTERNAL_SHAKER_PAN_SPEED,
        EE_LC_EXTERNAL_SHAKER_TILT_SPEED,
        EE_LC_EXTERNAL_SHAKER_ROLL_SPEED,
